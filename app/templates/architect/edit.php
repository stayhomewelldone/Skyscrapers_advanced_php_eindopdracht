...
<?php if (isset($architect)): ?>
    <h1 class="title mt-4">Edit <em><?= $architect->name; ?></em></h1>
        ...
        <form class="column is-6" action="" method="post" enctype="multipart/form-data">
            <div class="field is-horizontal">
                ...
                <div class="field-body">
                    <input class="input" id="name" type="text" name="name" value="<?= $architect->name; ?>"/>
                </div>
            </div>
            <div class="field is-horizontal">
...
<?php endif; ?>
<a class="button mt-4" href="<?= BASE_PATH; ?>architects">&laquo; Go back to the list</a>
